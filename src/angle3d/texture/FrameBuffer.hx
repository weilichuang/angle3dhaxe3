 ...
 * {Renderer#copyFrameBuffer(angle3d.texture.FrameBuffer, angle3d.texture.FrameBuffer) }.
 * The content of a {RenderBuffer} can be retrieved by using
 * {Renderer#readFrameBuffer(angle3d.texture.FrameBuffer, java.nio.ByteBuffer) }.
 * <p>
 ...
 *
 * @see Renderer#setFrameBuffer(angle3d.texture.FrameBuffer)
 *
 */
class FrameBuffer {
