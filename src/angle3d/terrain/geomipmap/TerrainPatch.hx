...
import angle3d.scene.BatchHint;
...
import angle3d.terrain.geomipmap.lodcalc.util.EntropyComputeUtil;
import angle3d.terrain.geomipmap.TerrainQuad.LocationHeight;
