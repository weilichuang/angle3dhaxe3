...
import angle3d.effect.cpu.influencers.DefaultParticleInfluencer;
import angle3d.effect.cpu.influencers.IParticleInfluencer;
import angle3d.effect.cpu.shape.EmitterPointShape;
import angle3d.effect.cpu.shape.EmitterShape;
 ...
 * {ParticleEmitter#setParticleInfluencer(angle3d.effect.influencers.ParticleInfluencer) }.
...
//        return unusedIndices.size() + next;
	 ...
	 *
	 * @see ParticleEmitter#setFaceNormal(angle3d.math.Vector3f)
	 */
	 ...
	 *
	 * @see ParticleEmitter#setEndColor(angle3d.math.ColorRGBA)
	 */
	 ...
	 *
	 * @see ParticleEmitter#setGravity(angle3d.math.Vector3f)
	 */
	 ...
	 *
	 * @see ParticleEmitter#setStartColor(angle3d.math.ColorRGBA)
	 */
