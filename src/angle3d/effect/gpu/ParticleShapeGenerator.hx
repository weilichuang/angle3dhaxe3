...
import angle3d.effect.gpu.influencers.acceleration.IAccelerationInfluencer;
import angle3d.effect.gpu.influencers.alpha.IAlphaInfluencer;
import angle3d.effect.gpu.influencers.angle.DefaultAngleInfluencer;
import angle3d.effect.gpu.influencers.angle.IAngleInfluencer;
import angle3d.effect.gpu.influencers.birth.DefaultBirthInfluencer;
import angle3d.effect.gpu.influencers.birth.IBirthInfluencer;
import angle3d.effect.gpu.influencers.color.IColorInfluencer;
import angle3d.effect.gpu.influencers.life.DefaultLifeInfluencer;
import angle3d.effect.gpu.influencers.life.ILifeInfluencer;
import angle3d.effect.gpu.influencers.position.DefaultPositionInfluencer;
import angle3d.effect.gpu.influencers.position.IPositionInfluencer;
import angle3d.effect.gpu.influencers.scale.DefaultScaleInfluencer;
import angle3d.effect.gpu.influencers.scale.IScaleInfluencer;
import angle3d.effect.gpu.influencers.spin.DefaultSpinInfluencer;
import angle3d.effect.gpu.influencers.spin.ISpinInfluencer;
import angle3d.effect.gpu.influencers.spritesheet.DefaultSpriteSheetInfluencer;
import angle3d.effect.gpu.influencers.spritesheet.ISpriteSheetInfluencer;
import angle3d.effect.gpu.influencers.velocity.EmptyVelocityInfluencer;
import angle3d.effect.gpu.influencers.velocity.IVelocityInfluencer;
