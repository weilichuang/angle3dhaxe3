...
import angle3d.app.state.AppState;
import angle3d.app.state.AppStateManager;
import angle3d.cinematic.events.AbstractCinematicEvent;
import angle3d.cinematic.events.CinematicEvent;
import angle3d.renderer.Camera;
import angle3d.renderer.RenderManager;
import angle3d.scene.CameraNode;
 ...
 * angle3d.cinematic.events
 *
 * Two main methods can be used to add an event :
 *
 * @see Cinematic#addCinematicEvent(float,
 * angle3d.cinematic.events.CinematicEvent) , that adds an event at the given
 * time form the cinematic start.
 *
 * @see
 * Cinematic#enqueueCinematicEvent(angle3d.cinematic.events.CinematicEvent)
 ...
 * @see Cinematic#bindCamera(String, angle3d.renderer.Camera)
