...
import angle3d.post.SceneProcessor;
import angle3d.math.Color;
import angle3d.renderer.queue.RenderQueue;
 ...
 * <p>
 * A viewport has a {#ViewPort(String, angle3d.renderer.Camera) camera}
 * which is used to render a set of {#attachScene(angle3d.scene.Spatial) scenes}.
 ...
 * via the {#setBackgroundColor(angle3d.math.Color)} method.
 * <p>
...
class ViewPort {
	 ...
	 * <ul>
	 * <li>{RenderManager#createPreView(String, angle3d.renderer.Camera) }</li>
	 * <li>{RenderManager#createMainView(String, angle3d.renderer.Camera)  }</li>
	 * <li>{RenderManager#createPostView(String, angle3d.renderer.Camera)  }</li>
	 * </ul>
	 *
	 ...
	 *
	 * @see attachScene(angle3d.scene.Spatial)
	 */
