 ...
 */
@:access(angle3d.material.RenderState)
@:access(angle3d.post.Filter)
class FilterPostProcessor implements SceneProcessor {
	 ...
	 * @param mat
	 */
	private function renderProcessing(r:Renderer, buff:FrameBuffer, mat:Material):Void {
	 ...
	 * @param sceneFb
	 */
	private function renderFilterChain(r:Renderer, sceneFb:FrameBuffer):Void {
