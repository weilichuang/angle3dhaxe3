...
import angle3d.scene.RefreshFlag;
import angle3d.renderer.FrustumIntersect;
...
class Spatial implements Cloneable implements Collidable {
	...
	*/
	 ...
	 * Unlike `angle3d.math.Quaternion.lookAt` this method takes a world position to
	 ...
	 * controls attached to this Spatial using the `angle3d.scene.control.Control.render()` method.
	 *
