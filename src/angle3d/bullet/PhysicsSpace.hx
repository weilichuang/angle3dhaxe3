...
import angle3d.bullet.collision.PhysicsCollisionEventFactory;
import angle3d.bullet.collision.PhysicsCollisionGroupListener;
import angle3d.bullet.collision.PhysicsCollisionListener;
import angle3d.bullet.collision.PhysicsCollisionObject;
import angle3d.bullet.collision.PhysicsRayTestResult;
import angle3d.bullet.collision.PhysicsSweepTestResult;
import angle3d.bullet.collision.shapes.CollisionShape;
import angle3d.bullet.control.PhysicsControl;
import angle3d.bullet.control.RigidBodyControl;
import angle3d.bullet.joints.PhysicsJoint;
import angle3d.bullet.objects.PhysicsCharacter;
...
class PhysicsSpace {
	...
	public function create():Void {
		...
		dynamicsWorld.setGravity(new angle3d.math.Vector3f(0, -9.81, 0));
	...
	public function sweepTest(shape:CollisionShape,
							  start:angle3d.math.Transform,
							  end:angle3d.math.Transform,
...
@:access(angle3d.bullet.PhysicsSpace.collisionGroupListeners)
...
@:access(angle3d.bullet.PhysicsSpace.tickListeners)
...
@:access(angle3d.bullet.PhysicsSpace.eventFactory)
@:access(angle3d.bullet.PhysicsSpace.collisionEvents)
