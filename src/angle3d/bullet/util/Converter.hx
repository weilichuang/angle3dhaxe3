...
class Converter {
	public static inline function convertTransformFromAngle3D(inT:angle3d.math.Transform, out:com.bulletphysics.linearmath.Transform):com.bulletphysics.linearmath.Transform {
		out.origin.copyFrom(inT.translation);
		out.basis.fromQuaternion(inT.rotation);
		return out;
	}

	public static inline function convertTransformFromBullet(inT:com.bulletphysics.linearmath.Transform, out:angle3d.math.Transform):angle3d.math.Transform {
