...
import angle3d.bullet.collision.shapes.HeightfieldCollisionShape;
import angle3d.bullet.collision.shapes.HullCollisionShape;
import angle3d.bullet.collision.shapes.infos.ChildCollisionShape;
...
import angle3d.terrain.geomipmap.TerrainPatch;
