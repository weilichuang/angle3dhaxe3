...
import angle3d.bullet.objects.infos.RigidBodyMotionState;
...
class PhysicsRigidBody extends PhysicsCollisionObject {
	...
	private var tempVec:angle3d.math.Vector3f = new angle3d.math.Vector3f();
	private var tempVec2:angle3d.math.Vector3f = new angle3d.math.Vector3f();
	private var tempTrans:Transform = new Transform();
	private var tempMatrix:angle3d.math.Matrix3f = new angle3d.math.Matrix3f();
	//TEMP VARIABLES
	private var localInertia:angle3d.math.Vector3f = new angle3d.math.Vector3f();
