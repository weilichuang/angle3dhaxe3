...
class NormalMapLecture extends BasicLecture
{
	static function main() 
	{
		flash.Lib.current.addChild(new NormalMapLecture());
	}
	...
	private function _loadComplete(loader:FilesLoader):Void
	{
		...
		geomtry1.setTranslationXYZ( 0, 0, -5);
		...
		geomtry2.setTranslationXYZ( 0, 0, 5);
		...
		var cc : ChaseCamera = new ChaseCamera(this.camera, geomtry2, mInputManager);
