...
private typedef InnerData = #if js Float32Expand #else Array<org.angle3d.types.Float32> #end
...
abstract FloatBuffer(InnerData)
{
	...
	public inline function push( v : org.angle3d.types.Float32 )
	{
		this.push(v);
	}
	...
	@:arrayAccess inline function arrayRead(key:Int) : org.angle3d.types.Float32
	{
		return this[key];
	}

	@:arrayAccess inline function arrayWrite(key:Int, value : org.angle3d.types.Float32) : org.angle3d.types.Float32
	{
