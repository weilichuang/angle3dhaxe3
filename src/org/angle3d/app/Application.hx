 ...
 * real-time 3D rendering Angle3D application.
 *
 * An `Application` provides all the tools that are commonly used in Angle3D3
 * applications.
 *
 * Angle3D applications should extend this class and call start() to begin the
 * application.
 *
 */
